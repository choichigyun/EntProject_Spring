...
public class EntDTO {
    ...
    public EntDTO(String ent_id, String ent_menu, String ent_menu_picture) {
		super();
		this.ent_id = ent_id;
	...
	public EntDTO(String ent_id, String ent_nick, String ent_name, String ent_lat, String ent_long, String ent_open,
			String ent_close, String ent_location, String ent_proof) {
		super();
		this.ent_id = ent_id;
    ...
    public EntDTO(String ent_name, String ent_lat, String ent_long, String ent_proof) {
		super();
		this.ent_name = ent_name;
		this.ent_lat = ent_lat;
		this.ent_long = ent_long;
